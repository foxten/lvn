...
class PublisherExportCreateApi(BaseApi):
    ...
    def create_access_report_export(self, aid: str, export_name: str, date_from: datetime, date_to: datetime, access_status: str = None, term_type: List[str] = None, term_id: List[str] = None, next_billing_date: datetime = None, last_payment_status: str = None) -> ApiResponse[Export]:
