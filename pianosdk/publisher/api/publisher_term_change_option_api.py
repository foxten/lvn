...
class PublisherTermChangeOptionApi(BaseApi):
    ...
    def create(self, aid: str, from_term_id: str, to_term_id: str, billing_timing: str, immediate_access: bool, prorate_access: bool, description: str = None) -> ApiResponse[TermChangeOption]:
