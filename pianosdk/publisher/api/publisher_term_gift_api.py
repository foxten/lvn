...
class PublisherTermGiftApi(BaseApi):
    ...
    def create_gift_term(self, aid: str, name: str, rid: str, term_type: str = 'subscription', description: str = None, product_category: str = None, billing_plan_period: str = None, billing_plan_price: float = None, billing_plan_currency: str = None, payment_allow_promo_codes: bool = True, vouchering_policy_redemption_url: str = None, schedule_id: str = None, schedule_billing_model: str = None, shared_account_count: int = None, shared_redemption_url: str = None) -> ApiResponse[Term]:
    ...
    def update_gift_term(self, aid: str, term_id: str, name: str, rid: str, term_type: str = 'subscription', description: str = None, product_category: str = None, billing_plan_period: str = None, billing_plan_price: float = None, billing_plan_currency: str = None, payment_allow_promo_codes: bool = True, vouchering_policy_redemption_url: str = None, schedule_id: str = None, schedule_billing_model: str = None, shared_account_count: int = None, shared_redemption_url: str = None, collect_address: bool = None, collect_shipping_address: bool = None, delivery_zone: List[str] = None, default_country: str = None) -> ApiResponse[Term]:
