...
class PublisherSubscriptionApi(BaseApi):
    ...
    def update(self, aid: str, subscription_id: str, next_bill_date: datetime = None, auto_renew: bool = None, payment_method_id: str = None, user_address_id: str = None) -> ApiResponse[bool]:
