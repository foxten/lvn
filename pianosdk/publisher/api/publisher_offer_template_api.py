...
class PublisherOfferTemplateApi(BaseApi):
    ...
    def get_duplicate(self, aid: str, offer_template_id: str, history_comment: str = None) -> ApiResponse[OfferTemplateVersion]:
    ...
    def list_boilerplates(self, aid: str, categories: List[str], offset: int = 0, limit: int = 100, q: str = None, order_by: str = None, order_direction: str = None, status: str = None, template_type: str = None) -> ApiResponse[List[OfferTemplateCategories]]:
    ...
    def list_by_category(self, aid: str, categories: List[str], offset: int = 0, limit: int = 100, status: str = None, template_type: str = None, q: str = None, order_by: str = None, order_direction: str = None) -> ApiResponse[List[OfferTemplateCategories]]:
