...
class PublisherTermChangeApi(BaseApi):
    ...
    def change(self, aid: str, uid: str, subscription_from: str, term_to: str, billing_timing: str, immediate_access: bool, prorate_access: bool, shared_accounts: str = None, user_address: str = None) -> ApiResponse[bool]:
