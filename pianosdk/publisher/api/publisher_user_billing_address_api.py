...
class PublisherUserBillingAddressApi(BaseApi):
    ...
    def create(self, aid: str, uid: str, country: str, region: str, zip: str, type: int, city: str = None, line1: str = None, line2: str = None, line3: str = None) -> ApiResponse[UserBillingAddress]:
        ...
        _parameters = {
            ...
            'zip': _encode_parameter(zip),
            'line1': _encode_parameter(line1),
            'line2': _encode_parameter(line2),
            'line3': _encode_parameter(line3),
