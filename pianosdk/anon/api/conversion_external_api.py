...
class ConversionExternalApi(BaseApi):
    ...
    def external_verified_create(self, aid: str, term_id: str, fields: str, user_token: str = None, user_provider: str = None, user_ref: str = None) -> ApiResponse[TermConversion]:
