...
class ConversionApi(BaseApi):
    ...
    def log_conversion(self, tracking_id: str, term_id: str, term_name: str, step_number: int = None, conversion_category: str = None, amount: float = None, currency: str = None, custom_params: str = None) -> ApiResponse[Dict]:
    ...
    def log_funnel_step(self, tracking_id: str, step_number: int, step_name: str, custom_params: str = None) -> ApiResponse[Dict]:
    ...
    def log_micro_conversion(self, tracking_id: str, event_group_id: str, custom_params: str = None) -> ApiResponse[Dict]:
