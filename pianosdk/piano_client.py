...
from pianosdk.publisher.api.publisher_term_link_api import PublisherTermLinkApi
...
class Client:
    def __init__(self, timeout: int = 60, max_retries: int = 3, backoff_factor: int = 0,
                 ...
                 additional_headers: Dict = None, config: Configuration = None) -> None:
        """
